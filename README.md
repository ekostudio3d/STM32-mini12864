...
[5. Mainsail - Fluidd configuration](#5-mainsail---fluidd-configuration)

[6. Find and add serial number](#6-find-and-add-serial-number)  
...
![Image](https://github.com/ekostudio3d/STM32-mini12864/blob/main/Images/cap6.0.png)
 ...
 - We will only leave these options enabled 
...
### You now have the latest version of klipper for your board.
 
### 4. Board in DFU mode

![Image](https://github.com/ekostudio3d/STM32-mini12864/blob/main/Images/board_view.png)
...
![Image](https://github.com/ekostudio3d/STM32-mini12864/blob/main/Images/cap5.png)
 ...
 - Now flash the firmware with the following command, it will ask for your PI password again to continue with the flashing process
...
## 5. Mainsail - Fluidd configuration
...
## 6. Find and add serial number

### It is important to know the serial number of our board to be able to include it in the file that we have just included in our configuration, with the command “ls /dev/serial/by-id/*” you can find the serial number of the STM32-mini12864 boar. 
...
### Save and restart the system so that the changes made can be processed.
